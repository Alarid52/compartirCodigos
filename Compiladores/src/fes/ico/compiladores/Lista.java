...
public class Lista {
    ...
    public int cantidadNodos() {
        int can = 0;
        /* empezamos con cantidad igual a 0  */
        Nodo aux = primerNodo;
        /* decimos que el auxiliar es igual a cabeza osea posicion1  */
        while (aux != null) {
            /* ciclo hasta que el auxiliar sea nulo  */
            can++;
            /* aumente la cantidad  */
            aux = aux.siguienteNodo;
            /* y el auxiliar sea de siguiente en siguiente  */
